<div align="center">
  ...
  ### Modern & High-Performance Doctor Portfolio Website

  A sleek, evidence-based doctor portfolio website designed for Senior Consultant Physicians specializing in **Preventative & Clinical Cardiology**. Features an interactive 3D vascular anatomy explorer, multi-page navigation, consultation appointment scheduling, dual academic/experience timelines, and smooth scroll swipe-up card animations.
...
The portfolio focuses on a single, prestigious medical specialty — **Preventative & Clinical Cardiology** — showcasing advanced diagnostic procedures, biomarker lipid panels, non-invasive imaging, and verifiable academic credentials.
